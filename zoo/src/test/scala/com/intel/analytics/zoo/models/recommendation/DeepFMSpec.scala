...
class DeepFMSpec extends ZooSpecHelper {
  ...
  "test" should "work properly" in {
    val linear1 = math.pow(2.0, (math.log(8) / math.log(2)).toInt).toInt
    println(linear1)
...
class DeepFMSerialTest extends ModuleSerializationTest {
